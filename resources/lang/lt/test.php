...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'mielagloba_v14' ); ?></a>
    <?php if (!$hideHeader) { ?>
        <header class="u-clearfix u-header u-header" id="sec-7469">
            <div class="u-clearfix u-sheet u-sheet-1">
                <?php $logo = theme_get_logo(array(
                    'default_src' => "/images/GlobosnamailogoFBprofolis-01.jpg",
                    'default_url' => "http://mielagloba.lt/"
                )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="1003" data-image-height="1003" title="Mielagloba">
                ...
                echo Theme_NavMenu::getMenuHtml(array(
                    ...
                    'menu' => array(
                        ...
                        'link_class' => 'u-active-custom-color-1 u-button-style u-hover-grey-5 u-nav-link u-text-active-white u-text-hover-black',
                        'link_style' => 'padding: 10px 20px;',
                        'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-840a-19',
                    ...
                    'responsive_menu' => array(
                        ...
                        'link_style' => '',
                        'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-840a-17',
                        'submenu_item_class' => 'u-nav-item',
                        'submenu_link_class' => 'u-button-style u-nav-link u-white',
                        'submenu_link_style' => '',
                    ),
